...
function App() {
  ...
  return (
      <div className="app">
          <Routes>
              <Route exact path="/" element={<ListBook books={books} onUpdate={updateBook} />} />
              <Route exact path="/search" element={<SearchBooks books={books} onUpdate={updateBook} />} />
              <Route exact path="/book/:id" element={<DetailsBook />} />
              <Route exact path="/search/book/:id" element={<DetailsBook />} />
          </Routes>
      </div>
  );
}
